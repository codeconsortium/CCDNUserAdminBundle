                ...
                ->arrayNode('gateway')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\AdminBundle\Model\Component\Gateway\UserGateway')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('repository')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\AdminBundle\Model\Component\Repository\UserRepository')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('manager')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\AdminBundle\Model\Component\Manager\UserManager')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('model')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\AdminBundle\Model\FrontModel\UserModel')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
